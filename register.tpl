...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row"> <?php require_once("face_buttons.tpl"); ?></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          ...
          <div class="form-group bestHideThis">
       ...
       /*
        ...
        <fieldset id="address">
          <legend><?php // echo $text_your_address; ?> تفاصيل العنوان</legend>
          <div class="form-group bestHideThis">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-address-1">العنوان<?php //echo $entry_address_1; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group _required bestHideThis">
        ...
        */
        ...
        <div class="buttons ">
          <div class="pull-right"><?php //echo $text_agree; ?>
            <?php if ($agree) { ?>
            <input type="checkbox" name="agree" class="bestHideThis" value="1"  checked="checked"/>
            <?php } else { ?>
            <input type="checkbox" name="agree" class="bestHideThis" value="1" checked="checked"/>
            <?php } ?>
            &nbsp;
